import {
  getAllUsers,
  updateCurrentUser,
} from '../../modules/personal-information/redux/userSlice';
...
describe('test user reducers', () => {
  ...
  //   await store.dispatch(
  //     loginByToken(
  //       'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzZGJiZDEyZTkzNjQ2NTJlNGRlMDM3ZiIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTY3ODc5MjYzNiwiZXhwIjoxNjc5MDUxODM2fQ.9krmMDnpAPvREmuXksfL2cNd-VVwMq3Sy9zPnZAiSrU'
  //     )
  //   );
  ...
  test('get all users', async () => {
    ...
    expect(store.getState().userReducer.data.length).toBeGreaterThan(1);
  });
  ...
  //       token:
  //         'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzZGJiZDEyZTkzNjQ2NTJlNGRlMDM3ZiIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTY3ODk2NTc0OSwiZXhwIjoxNjc5MjI0OTQ5fQ.Qfn3iyDnkQlI1S6S7stgRqvzKNyVRLbcUY309DQI07Y',
  //     })
  //   );
